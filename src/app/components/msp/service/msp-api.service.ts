                    ...
                    if(spaResponse && spaResponse.SPA_ENV_MSP_MAINTENANCE_FLAG && spaResponse.SPA_ENV_MSP_MAINTENANCE_FLAG === "true"){
                       ...
                       console.log(convertedAppXml)
                        if ( convertedAppXml.match(/(assistanceApplication)/)) {
                          convertedAppXml = '<?xml version="1.0"encoding="UTF-8"standalone="yes"?><ns2:application xmlns:ns2="http://www.gov.bc.ca/hibc/applicationTypes"><assistanceApplication><applicant><name><firstName>spicy</firstName><secondName>b</secondName><lastName>tuna</lastName></name><birthDate>1984-01-22</birthDate><mailingAddress><addressLine1>123 fake street</addressLine1><city>victoria</city><postalCode>BC</postalCode><provinceOrState>British Columbia</provinceOrState><country>Canada</country></mailingAddress><financials><taxYear>2018</taxYear><assistanceYear>CurrentPA</assistanceYear><numberOfTaxYears>1</numberOfTaxYears><netIncome>123</netIncome><spouseNetIncome>123</spouseNetIncome><totalNetIncome>246</totalNetIncome><sixtyFiveDeduction>0</sixtyFiveDeduction><childDeduction>0</childDeduction><deductions>0</deductions><totalDeductions>3000</totalDeductions><adjustedNetIncome>0</adjustedNetIncome></financials><phn>9999999998</phn><SIN>999999998</SIN><powerOfAttorney>N</powerOfAttorney></applicant><spouse><name><secondName>R</secondName><lastName>Bellringer</lastName></name><birthDate>1985-02-12</birthDate><phn>9329979953</phn><SIN>920720737</SIN><spouseDeduction>3000</spouseDeduction><spouseSixtyFiveDeduction>0</spouseSixtyFiveDeduction></spouse><authorizedByApplicant>Y</authorizedByApplicant><authorizedByApplicantDate>2019-05-30</authorizedByApplicantDate><authorizedBySpouse>Y</authorizedBySpouse></assistanceApplication><uuid>a08fed6c-5e01-b117-59d6-aa16511306ad</uuid></ns2:application>'
