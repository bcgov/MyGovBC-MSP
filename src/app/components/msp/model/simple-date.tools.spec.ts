...
describe('SimpleDateTools', () => {
    ...
    it('should convert SimpleDate to Moment', () => {
        const date: SimpleDate = {day: 11, month: 6, year: 1991};
        const x: any = SimpleDateTools(date).toMoment();
    ...
    it('should be able to string format a SimpleDate object', () => {
        const date: SimpleDate = {day: 11, month: 6, year: 1991};
        const formatted: String = SimpleDateTools(date).toMoment().format('MMMM Do, YYYY');
