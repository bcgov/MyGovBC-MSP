  ...
  "definitions": {
	...
	"AccountChangeChildrenType": {
      ...
      "AccountChangeApplicationType": {
        ...
        "required": ["accountHolder", "spouses"]
      },
      "FinancialsType": {
        "type": "object",
        "properties": {
      ...
      "SupplementaryBenefitsApplicationType": {
        ...
        "properties": {
		    ...
		    "applicantAttachmentUuids": {
              "$ref": "#/definitions/AttachmentUuidsType"
            },
            "spouseAttachmentUuids": {
              "$ref": "#/definitions/AttachmentUuidsType"
            }
        },
        "required": [ "applicantFirstName" , "applicantSecondName" , "applicantLastName" , "applicantBirthdate", "applicantPHN", "applicantSIN", "applicantAddressLine1" , "applicantCity" , "applicantProvinceOrState" , "applicantCountry" , "applicantPostalCode", "applicantTelephone", "authorizedByApplicant", "authorizedByApplicantDate", "powerOfAttorney", "assistanceYear", "taxYear", "numberOfTaxYears", "adjustedNetIncome", "childDeduction", "deductions", "disabilityDeduction", "sixtyFiveDeduction", "totalDeductions", "totalNetIncome", "childCareExpense", "netIncomeLastYear", "numChildren", "numDisabled", "spouseIncomeLine236", "reportedUCCBenefit", "spouseDSPAmount", "spouseDeduction", "applicantAttachmentUuids" ]
      },
      "AttachmentType": {
        "type": "object",
        "properties": {
