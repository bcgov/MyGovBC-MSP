...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      urlBase + "/authentication/:id",
      { 'id': '@id' },
      {

        /**
         * @ngdoc method
         * @name lbServices.Authentication#post
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
         ...
         */
        "createChangeStream": {
          url: urlBase + "/service/change-stream",
          method: "POST"
        },
      }
    );
