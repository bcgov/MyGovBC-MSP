...
node {
  ...
  stage('prebuild ' + BUILD_CONFIG) {
    ...
    sh 'pwd ; find .. -name environment.prod.ts.template ; find .. -name environment.prod.ts ; sed "s/process.env.mspIsInMaintenanceFlag/${mspIsInMaintenanceFlag}/;s/process.env.mspIsInMaintenanceText/${mspIsInMaintenanceText}/;s/process.env.mspIsInMaintenanceTimes/${mspIsInMaintenanceTimes}/" ./src/environments/environment.prod.ts.template >./src/environments/environment.prod.ts'
  }
